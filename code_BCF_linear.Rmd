...
for(rep in 1:n_rep) {
  ...
  bcf_fit_lin <- bcf(y = data_lin$Y, z = data_lin$Z,
                     ...
                     pihat = p_hat_lin, nburn=4000, nsim=4000, include_pi="control", update_interval=100)
  ...
  bcf_fit_nonlin <- bcf(y = data_nonlin$Y, z = data_nonlin$Z,
                        ...
                        pihat = p_hat_nonlin, nburn=4000, nsim=4000, include_pi="control", update_interval=100)
